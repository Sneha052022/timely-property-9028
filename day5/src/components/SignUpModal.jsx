        ...
        <div className={styles.container}>
            <div className={styles.modal}>
                ...
                <div className={styles.mid_footer}>
                    By clicking "Create an Account", you agree to our Terms of
                    Use and Privacy Policy, including the Use of Cookies and the
                    transfer of your personal information to the United States,
                    a jurisdiction that may not provide an equivalent level of
