                ...
                <div className={styles.right}>
                    <div className={styles.payment_total}>
                        ...
                        <div className={styles.checkout_container}>
                            ...
                            <div>
                                <p className={styles.dim}>
                                    By clicking ‘Check Out Now’, you will be
                                    redirected to the eShopWorld checkout page
                                    where payment will be taken and your order
                                    fulfilled by eShopWorld, J.Crew's preferred
                                    partner for international sales.
                                </p>
                            </div>
                        </div>
                    </div>
